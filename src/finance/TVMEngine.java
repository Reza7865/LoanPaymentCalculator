 ...
 * is specified using the enumerated type finance.enum.CompoundingOption.
 ...
 * used. Otherwise, use the TVMEngine constructor without parameters. In this
 * case you must set the compounding frequency with the setCompounding () method
 * and set the TVM registers by using the various "set" methods (e.g., setPV(),
 * setPMT, etc.).
 * <p>
...
public abstract class TVMEngine {
    ...
    /**
     * Gets the interest rate or rate of return
     * 
     * @return the interest rate or return specified as an annual percentage
     * rate (APR)
     */
    ...
    /**
     * Gets the time period (in years) over which the financial calculations
     * will apply (i.e., loan duration or amount of time money is invested).
     * 
     * @return the number of years over which the TVM calculation applies
     */
     ...
     * @return 
     */
    public final CompoundingOption getCompounding() {
        return compounding;
    }
    ...
    /**
     * Calculate the future value (e.g., value of an investment over a period of
     * time).
     *
